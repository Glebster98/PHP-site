                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 ml-auto mr-auto">
                            <div class="card p-4 rounded-plus bg-faded">
                                ...
                                <form id="js-login" novalidate="" action="checkingbd.php" method="post">
                                    <div class="form-group">
                                        <?php display_message('danger');?>
                                        <?php display_message('warning');?>
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="userpassword1">Подтвердите пароль <br></label>
                                        <input type="password" name="password1"  id="userpassword1" class="form-control" placeholder="" required>
                                        <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
